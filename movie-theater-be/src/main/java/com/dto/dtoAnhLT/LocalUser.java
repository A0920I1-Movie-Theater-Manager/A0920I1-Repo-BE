...
public class LocalUser extends User implements OAuth2User, OidcUser {
	...
	public static LocalUser create(com.model.entity.Account user, Map<String, Object> attributes, OidcIdToken idToken, OidcUserInfo userInfo) {
		LocalUser localUser = new LocalUser(user.getEmail(), user.getPassword(), user.isEnable(), true, true, true, GeneralUtils.buildSimpleGrantedAuthorities(user.getRoles()),
